...
class Config:
    class Paths:
        RESULT_ROOT = "/home/milab/machine_ws/Study/kitti_object_detection/dataset"
        TFRECORD = op.join(RESULT_ROOT, "tfrecord")

    class Tfrdata:
        DATASETS_FOR_TFRECORD = {"kittki":("train", "val")}
    ...
    class Datasets:
        ...
        class Kitti:
            NAME = "kitti"
            PATH = "/home/milab/machine_ws/Study/kitti_object_detection/dataset/kitti_detection"
